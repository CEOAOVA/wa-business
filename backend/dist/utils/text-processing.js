...
exports.truncateText = exports.formatCurrency = exports.extractProductCodes = exports.normalizeForSearch = exports.preprocessText = exports.sanitizeText = exports.priceToText = exports.numberToText = void 0;
/**
...
const numberToText = (num) => {
    ...
    if (num === 0)
        return "cero";
    if (num < 0)
        return "menos " + (0, exports.numberToText)(Math.abs(num));
    ...
    if (num < 1000) {
        ...
        return centenas[centena] + (resto > 0 ? " " + (0, exports.numberToText)(resto) : "");
    }
    ...
    if (num < 10000) {
        ...
        return (millar === 1 ? "mil" : unidades[millar] + " mil") +
            (resto > 0 ? " " + (0, exports.numberToText)(resto) : "");
    }
...
const priceToText = (price) => {
    ...
    let result = "";
    if (pesos > 0) {
        result += (0, exports.numberToText)(pesos) + (pesos === 1 ? " peso" : " pesos");
    }
    if (centavos > 0) {
        if (result)
            result += " con ";
        result += (0, exports.numberToText)(centavos) + (centavos === 1 ? " centavo" : " centavos");
    }
    if (result === "")
        result = "cero pesos";
...
const preprocessText = (text) => {
    ...
    try {
        ...
        text = (0, exports.sanitizeText)(text);
        ...
        processedText = processedText.replace(/\b\d+\b/g, (match) => {
            ...
            if (match.includes('.')) {
                ...
                if (!isNaN(num)) {
                    return (0, exports.priceToText)(num);
                }
            }
            const num = parseInt(match, 10);
            if (!isNaN(num)) {
                return (0, exports.numberToText)(num);
            }
            return match;
        });
 ...
 */
const extractProductCodes = (text) => {
    if (!text)
        return [];
    const codePatterns = [
...
exports.extractProductCodes = extractProductCodes;
/**
