...
exports.testAutomotivePartsSearch = testAutomotivePartsSearch;
...
function testAutomotivePartsSearch() {
    return __awaiter(this, void 0, void 0, function* () {
        console.log('🧪 Iniciando pruebas de búsqueda de piezas automotrices...\n');
        const partsSearchService = new automotive_parts_search_service_1.AutomotivePartsSearchService();
        ...
        for (const testCase of testCases) {
            ...
            try {
                ...
                const { carInfo, partName } = conversationService.extractCarAndPartInfo(testCase.message);
                if (carInfo && partName) {
                    ...
                    // Realizar búsqueda
                    const searchResult = yield partsSearchService.searchAutomotiveParts(partName, carInfo);
        ...
        for (const testCase of directTestCases) {
            ...
            try {
                const searchResult = yield partsSearchService.searchAutomotiveParts(testCase.partName, testCase.carInfo, { limit: 3, minConfidence: 0.3 });
                if (searchResult.success && searchResult.results.length > 0) {
