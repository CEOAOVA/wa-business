...
class FunctionService {
     ...
     */
    registerProductSearchFunctions() {
        // buscarProductoPorTermino - Nueva función para búsqueda de productos
        this.registerFunction('buscarProductoPorTermino', (args, context) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            try {
                ...
                const searchResult = yield productSearchService.searchProductFlow(termino, datosAuto, { limit });
        ...
        this.registerFunction('confirmarProductoSeleccionado', (args, context) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const { clave, confirmacion, indiceSeleccionado } = args;
        ...
        this.registerFunction('obtenerDetallesProducto', (args, context) => __awaiter(this, void 0, void 0, function* () {
            const { clave } = args;
        ...
        this.registerFunction('sugerirAlternativas', (args, context) => __awaiter(this, void 0, void 0, function* () {
     ...
     */
    registerAutomotivePartsFunctions() {
        // buscarPiezaAutomotriz - Nueva función específica para piezas automotrices
        this.registerFunction('buscarPiezaAutomotriz', (args, context) => __awaiter(this, void 0, void 0, function* () {
            const { nombrePieza, marcaAuto, modeloAuto, añoAuto, limit = 5 } = args;
            ...
            try {
                ...
                const { AutomotivePartsSearchService } = yield Promise.resolve().then(() => __importStar(require('../automotive-parts-search.service')));
                const partsSearchService = new AutomotivePartsSearchService();
                // Realizar búsqueda específica
                const searchResult = yield partsSearchService.searchAutomotiveParts(nombrePieza, { marca: marcaAuto, modelo: modeloAuto, año: añoAuto }, { limit, minConfidence: 0.4 });
     ...
     */
    generatePartSuggestions(nombrePieza) {
        const sugerencias = [
            'balatas delanteras',
            'balatas traseras',
            'filtro de aceite',
