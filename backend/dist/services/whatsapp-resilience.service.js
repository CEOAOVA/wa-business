...
exports.WhatsAppResilienceService = void 0;
const structured_logger_1 = require("../utils/structured-logger");
const whatsapp_service_1 = require("./whatsapp.service");
class WhatsAppResilienceService {
    /**
     * Enviar mensaje con retry logic
     */
    static sendMessageWithRetry(payload_1) {
        return __awaiter(this, arguments, void 0, function* (payload, config = {}) {
            ...
            for (let attempt = 0; attempt <= finalConfig.maxRetries; attempt++) {
                ...
                try {
                    ...
                    const result = yield whatsapp_service_1.whatsappService.sendMessage(payload);
                    if (result.success) {
     ...
     */
    static getPhoneNumberInfoWithRetry() {
    ...
    static isRetryableError(error, config) {
        ...
        const isRetryableCode = config.retryableErrors.some(retryableError => errorMessage.includes(retryableError) || errorCode.includes(retryableError));
        // Verificar códigos de estado HTTP retryables
        const statusCode = ((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) || error.status;
        ...
        const isNetworkError = networkErrors.some(netError => errorCode === netError || errorMessage.includes(netError));
        const isRetryable = isRetryableCode || isRetryableStatus || isNetworkError;
        structured_logger_1.StructuredLogger.logSystemEvent('error_retry_evaluation', {
            errorMessage: errorMessage.substring(0, 100), // Limitar longitud
            errorCode,
            statusCode,
            isRetryable,
            matchedRetryableError: config.retryableErrors.find(re => errorMessage.includes(re) || errorCode.includes(re))
        });
        return isRetryable;
    }
    /**
     ...
     */
    static executeWithRetry(operation_1, operationName_1) {
        return __awaiter(this, arguments, void 0, function* (operation, operationName, config = {}) {
            const finalConfig = Object.assign(Object.assign({}, this.defaultConfig), config);
...
exports.WhatsAppResilienceService = WhatsAppResilienceService;
WhatsAppResilienceService.defaultConfig = {
    maxRetries: 3,
