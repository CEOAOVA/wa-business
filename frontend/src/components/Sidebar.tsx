      ...
      <div className="px-4 py-3 border-t border-embler-accent bg-embler-gray">
        ...
        <div className="space-y-2 mb-2">
          <button
            ...
            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-3 rounded-lg transition-colors flex items-center justify-center gap-2 text-sm font-medium"
          ...
          <button
            ...
            className="w-full bg-gray-600 hover:bg-gray-700 text-white py-2 px-3 rounded-lg transition-colors flex items-center justify-center gap-2 text-sm font-medium"
            title="Ir a Página de Login"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
