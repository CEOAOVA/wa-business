/**
 * Script de debug para autenticación
 * Ejecuta este script en la consola del navegador (F12)
 */

console.log('🔧 Debug de Autenticación - WhatsApp Business Platform');
console.log('==================================================');
...
console.log('\n✅ Script de debug cargado. Usa los comandos listados arriba.'); 